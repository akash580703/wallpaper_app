...
import 'package:crash/screens/image_detail.dart';

class RecentPage extends StatefulWidget {
  final Stream<void> clearStream;
  final GlobalKey<ScaffoldState> scaffoldKey;

  const RecentPage({Key? key, required this.clearStream, required this.scaffoldKey})
      : super(key: key);
  ...
  Widget buildImageItem(ImageModel image) {
    ...
    final listTile = ListTile(
      ...
      trailing: IconButton(
        ...
        onPressed: () => removeImage(image.id.toString()),
      ),
    );
    ...
    return Dismissible(
      ...
      onDismissed: (_) => removeImage(image.id.toString()),
